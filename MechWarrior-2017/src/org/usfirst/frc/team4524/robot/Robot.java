...
public class Robot extends IterativeRobot {
	...
	public SendableChooser<String> robotChooser = new SendableChooser<String>();
	...
	public void robotInit() {
		...
		robotChooser.addObject("Good Robot", "goodrobot");
		robotChooser.addObject("Bad Robot", "badrobot");
		robotChooser.addDefault("PacGoat Simulation", "pacgoat");
		robotChooser.addObject("GearBots Simulation", "gearbots");
		...
		robotChoice = robotChooser.getSelected();
